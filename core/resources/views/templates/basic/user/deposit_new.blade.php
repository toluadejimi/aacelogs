        ...
        <div class="col-md-12">
            ...
            @forelse($deposits as $deposit)
                <div class="item-box">
                    ...
                    @if($deposit->method_code == 1000 || $deposit->method_code == 250 )
                        <div class="item-media mt-2">
                            <svg width="70" height="70" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 9V15C3 17.828 3 19.243 3.879 20.121C4.757 21 6.172 21 9 21H15C17.828 21 19.243 21 20.121 20.121C21 19.243 21 17.828 21 15V9C21 6.172 21 4.757 20.121 3.879C19.243 3 17.828 3 15 3H9" stroke="#34A853" stroke-width="2" stroke-linecap="round"/>
                                <path d="M15 15V16H16V15H15ZM7.70698 6.29301C7.51838 6.11085 7.26578 6.01006 7.00358 6.01234C6.74138 6.01461 6.49057 6.11978 6.30516 6.30519C6.11975 6.4906 6.01458 6.74141 6.01231 7.00361C6.01003 7.26581 6.11082 7.51841 6.29298 7.70701L7.70698 6.29301ZM14 8.00001V15H16V8.00001H14ZM15 14H7.99998V16H15V14ZM15.707 14.293L7.70698 6.29301L6.29298 7.70701L14.293 15.707L15.707 14.293Z" fill="#34A853"/>
                            </svg>
                        </div>
                    @else

                        <div class="item-media mt-2">
                            <svg width="70" height="70" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.75975 21.9163L15.7576 22.0772C18.5846 22.153 19.9991 22.191 20.9003 21.3358C21.8025 20.4817 21.8405 19.0672 21.9163 16.2402L22.0772 10.2424C22.153 7.41539 22.1909 6.0009 21.3358 5.09965C20.4817 4.19743 19.0672 4.15949 16.2402 4.08367L10.2423 3.9228C7.41536 3.84698 6.00087 3.80904 5.09962 4.66418C4.19739 5.5183 4.15946 6.93279 4.08363 9.75978L3.92277 15.7576" stroke="#EA4335" stroke-width="2" stroke-linecap="round"/>
                                <path d="M16.0793 10.0815L17.079 10.1083L17.1058 9.10867L16.1061 9.08186L16.0793 10.0815ZM7.17993 17.1384C6.99278 17.3221 6.88525 17.5719 6.8805 17.8341C6.87575 18.0962 6.97415 18.3498 7.15452 18.5401C7.33489 18.7304 7.5828 18.8422 7.84484 18.8516C8.10688 18.8609 8.36209 18.7669 8.55551 18.5898L7.17993 17.1384ZM9.05504 10.8935L16.0525 11.0811L16.1061 9.08186L9.10866 8.89418L9.05504 10.8935ZM15.0797 10.0547L14.892 17.0522L16.8913 17.1058L17.079 10.1083L15.0797 10.0547ZM15.3915 9.3558L7.17993 17.1384L8.55551 18.5898L16.7671 10.8072L15.3915 9.3558Z" fill="#EA4335"/>
                            </svg>
                        </div>
                    @endif
                            ...
                            <div class="item-footer">
                                ...
                                <a href="javascript:void(0);" class="item-bookmark">
                                    ...
                                    @elseif($deposit->status == 2)
                                        <a href="/user/resolve-deposit?trx={{$deposit->trx}}" class="btn btn-warning btn-sm">Resolve</a>
