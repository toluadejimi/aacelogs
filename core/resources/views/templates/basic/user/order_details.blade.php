                    ...
                    <table class="table">
                        ...
                        @forelse($orderItems as $item)
                            <tr>
                                ...
                                <td>
                                    <input  type="text"  id="copy@php echo nl2br(@$item->productDetail->id) @endphp" class="form-control text-small"  style="font-size: smaller; border: none" value="@php echo nl2br(@$item->productDetail->details) @endphp">
                                ...
                                <td>
                                    <button  class="copy-button form-control" onclick="copyToClipboard{{$id}}()">
