...
class ManageUsersController extends Controller
{
    ...
    public function addbalance(Request $request,$id)
    {
        ...
        $message = "ACELOG STORE | Admin has funded | $usr->email | NGN $amount |";
    ...
    public function removebalance(Request $request,$id)
    {
        ...
        $usr= User::where('id', $id)->first();
        $amount = number_format($request->amount);
        $message = "ACE LOG STORE | Admin has removed | $usr->email | NGN $amount |";
    ...
    protected function userData($scope = null){
        ...
        return $users->searchable(['username','email'])->orderBy('balance','desc')->paginate(getPaginate());
    }
